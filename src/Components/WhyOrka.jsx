      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-zinc-600 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
            We combine local expertise with high standards to deliver seamless
            legal solutions that protect your interests and elevate your
            confidence in every transaction, negotiation, or dispute.
          </p>
        </div>
